...
$(document).ready(function(){   
	...
	$(window).scroll(function() {
		...
		if (scroll > offset && counter == 0) {
			$('.glimpes-wrap .btn').addClass('show');
			counter = 1;
	...
	var $element_two = $('.build-wrap');
    let counter2 = 0;
	
	$(window).scroll(function() {
		var scroll = $(window).scrollTop() + $(window).height();		

		var offset = $element_two.offset().top + $element_two.height();

		if (scroll > offset && counter == 0) {
			$('.build-wrap .btn').addClass('show');
			counter2 = 1;
